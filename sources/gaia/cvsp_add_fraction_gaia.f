...
!>@param[in] DZFCL Evolution of fraction i [m]
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
...
!-----------------------------------------------------------------------
!
      RET = CVSP_CHECK_F_GAIA(J,PRO_MAX(J),'ADF: MAX  ')
      RET = CVSP_CHECK_F_GAIA(J,PRO_MAX(J)-1,'ADF: MAX+1')
      IF (PRO_MAX(J).GT.2) THEN
        RET =  CVSP_CHECK_F_GAIA(J,PRO_MAX(J)-2,'ADF: MAX+2')
      ENDIF
      IF (PRO_MAX(J).GT.3) THEN
        RET = CVSP_CHECK_F_GAIA(J,PRO_MAX(J)-3,'ADF: MAX+3')
      ENDIF
!
!-----------------------------------------------------------------------
!
