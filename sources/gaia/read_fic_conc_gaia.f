...
!
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!>@param[in]     AT       Time_rfc in seconds
!>@param[in]     LISTIN   If yes, prints information
!>@param[in]     NFIC     Logical unit of file
!>@param[in,out] CGL_GAIA Variable read and interpolated
!>@param[out]    FOUND    If false: variable not found
!>@param[in]     WHAT     Variable to look for in 8 characters
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
      USE DECLARATIONS_GAIA, ONLY : DEJA_RFC,INFIC_RFC,TIME_RFC,
...
!
        ...
        ELSE
          WRITE(LU,*) 'INCREASE MAXVAL_RFC IN DECLARATIONS_GAIA'
          CALL PLANTE(1)
          STOP
        ENDIF
...
70    IF(AT.GE.TL1_RFC-TOL.AND.AT.LE.TL2_RFC+TOL) THEN
      ...
      ENDIF
!
      CGL_GAIA = (1.D0-TETA)*INFIC_RFC(IWHAT,IL1_RFC)
