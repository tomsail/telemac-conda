...
! Allocation des variables specifiques a MASCARET
   ...
   if (Model%Noyau == NOYAU_MASCARET) then
       ...
       if (retour /= 0) then
          Erreur = retour
          ptrMsgsErreurs(Identifiant) = 'INIT_LIGNE_MASCARET - Unable to allocate State.IDEB'
          return
       endif
       ...
       if (retour /= 0) then
          Erreur = retour
          ptrMsgsErreurs(Identifiant) = 'INIT_LIGNE_MASCARET - Unable to allocate State.IFIN'
          return
       endif
       ...
       if (retour /= 0) then
          Erreur = retour
          ptrMsgsErreurs(Identifiant) = 'INIT_LIGNE_MASCARET - Unable to allocate State.ITEM0'
          return
       endif
       ...
       if (retour /= 0) then
          Erreur = retour
          ptrMsgsErreurs(Identifiant) = 'INIT_LIGNE_MASCARET - Unable to allocate State.ZINIT'
          return
       endif
