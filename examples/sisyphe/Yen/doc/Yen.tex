...
\begin{figure} [!h]
\centering
\includegraphicsmaybe{[width=.96\textwidth]}{../img/EvolutionR04.png}
 \caption{Comparison of simulated (coloured) and measured (black contour lines) normalized bed evolution.}\label{fig:results1}
\end{figure}

\begin{figure} [!h]
\centering
\includegraphicsmaybe{[width=.96\textwidth]}{../img/Cross_sections_90.png}
\includegraphicsmaybe{[width=.96\textwidth]}{../img/Cross_sections_180.png}
