...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        """
        # littoral T2D+TOM+SIS tel2tom same mesh
        ...
        # littoral T2D+TOM+SIS tel2tom2 different mesh
        ...
        # littoral T2D+TOM+SIS tel2tom2 different mesh contour telemac
        ...
        # littoral T2D+TOM+SIS tel2tom2 different mesh contour tomawac
...
# Comparison with contour on Tomawac
        ...
        # Comparison with the last time frame of the reference file.
        self.check_epsilons('vnv_7:SISRES',
                            'ref_sis_contTom.slf',
                            eps=[1e-9])

        # Comparison with the last time frame of the reference file.
        self.check_epsilons('vnv_8:SISRES',
                            'ref_sis_contTom.slf',
                            eps=[1e-9])
