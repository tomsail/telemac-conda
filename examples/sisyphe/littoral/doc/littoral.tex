...
\section{Purpose}
%
This test case illustrates the setup of a three-way coupling problem waves, currents and
sediment transport.

%
\section{Description of the problem}
A wave, current and sediment transport simulation in a straight, uniform stretch of
coastline is considered. The beach is located at $y = 200$~m, the sloping bed is imposed
in subroutine \texttt{corfon}. The offshore depth is $10$~m.
...
A domain of $200\times 1000$~m$^2$ is considered, with a regular mesh with elements size
of the order $\Delta x=20$~m and $\Delta y=5$~m
...
\begin{figure} [!h]
\centering
\includegraphicsmaybe{[width=0.85\textwidth]}{../img/resultsSISTEL2TOM.png}
...
\begin{figure} [!h]
\centering
\includegraphicsmaybe{[width=0.85\textwidth]}{../img/resultsSISTEL2TOMdiff.png}
