...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        self.add_study('vnv_1', 'telemac2d', 't2d_reservoir_monoclass.cas')

        # thermal budget under icy conditions (parallel)
        cas = TelemacCas('t2d_reservoir_monoclass.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('vnv_2', 'telemac2d', 't2d_reservoir_monoclass_par.cas', cas=cas)
        del cas
    ...
    def _check_results(self):
        ...
        """
        self.check_epsilons('vnv_1:T2DRES', 'f2d_reservoir_monoclass.slf', eps=[1.E-6])
        self.check_epsilons('vnv_2:T2DRES', 'f2d_reservoir_monoclass.slf', eps=[1.E-6])
