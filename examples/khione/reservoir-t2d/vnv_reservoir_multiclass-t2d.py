...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        self.add_study('vnv_1', 'telemac2d', 't2d_reservoir_multiclass.cas')

        # thermal budget under icy conditions (parallel)
        cas = TelemacCas('t2d_reservoir_multiclass.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('vnv_2', 'telemac2d', 't2d_reservoir_multiclass_par.cas', cas=cas)
        del cas

        # thermal budget melting (serial)
        self.add_study('vnv_3', 'telemac2d', 't2d_reservoir_multiclass_melting.cas')

        # thermal budget melting (parallel)
        cas = TelemacCas('t2d_reservoir_multiclass_melting.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('vnv_4', 'telemac2d', 't2d_reservoir_multiclass_melting_par.cas', cas=cas)
        del cas
        ...
        self.add_study('vnv_seed0', 'telemac2d', 't2d_reservoir_multiclass_seed0.cas', cas=cas)
        ice_cas.set('MODEL FOR FRAZIL SEEDING', 2)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_seed2', 'telemac2d', 't2d_reservoir_multiclass_seed2.cas', cas=cas)
        ice_cas.set('MODEL FOR FRAZIL SEEDING', 3)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_seed3', 'telemac2d', 't2d_reservoir_multiclass_seed3.cas', cas=cas)
        del cas
        ...
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_sr1', 'telemac2d', 't2d_reservoir_multiclass_sr1.cas', cas=cas)
        ice_cas.set('FRAZIL SEEDING RATE', [6.E3, 0., 0., 0., 0., 0., 0., 0., 0., 0.])
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_sr2', 'telemac2d', 't2d_reservoir_multiclass_sr2.cas', cas=cas)
        ice_cas.set('FRAZIL SEEDING RATE', [8.E3, 0., 0., 0., 0., 0., 0., 0., 0., 0.])
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_sr3', 'telemac2d', 't2d_reservoir_multiclass_sr3.cas', cas=cas)
        ice_cas.set('FRAZIL SEEDING RATE', [10.E3, 0., 0., 0., 0., 0., 0., 0., 0., 0.])
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_sr4', 'telemac2d', 't2d_reservoir_multiclass_sr4.cas', cas=cas)
        del cas
        ...
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_min1', 'telemac2d', 't2d_reservoir_multiclass_min1.cas', cas=cas)
        ice_cas.set('MINIMUM NUMBER OF FRAZIL CRYSTALS', 2000.)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_min2', 'telemac2d', 't2d_reservoir_multiclass_min2.cas', cas=cas)
        ice_cas.set('MINIMUM NUMBER OF FRAZIL CRYSTALS', 4000.)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_min3', 'telemac2d', 't2d_reservoir_multiclass_min3.cas', cas=cas)
        ice_cas.set('MINIMUM NUMBER OF FRAZIL CRYSTALS', 5000.)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_min4', 'telemac2d', 't2d_reservoir_multiclass_min4.cas', cas=cas)
        del cas
        ...
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_nofloc', 'telemac2d', 't2d_reservoir_multiclass_nofloc.cas', cas=cas)
        del cas
        ...
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_af6', 'telemac2d', 't2d_reservoir_multiclass_af6.cas', cas=cas)
        ice_cas.set('FLOCCULATION AFLOC PARAMETER', 1e-5)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_af5', 'telemac2d', 't2d_reservoir_multiclass_af5.cas', cas=cas)
        ice_cas.set('FLOCCULATION AFLOC PARAMETER', 1e-3)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_af3', 'telemac2d', 't2d_reservoir_multiclass_af3.cas', cas=cas)
        ice_cas.set('FLOCCULATION AFLOC PARAMETER', 1e-2)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_af2', 'telemac2d', 't2d_reservoir_multiclass_af2.cas', cas=cas)
        del cas
        ...
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_sn4', 'telemac2d', 't2d_reservoir_multiclass_sn4.cas', cas=cas)
        ice_cas.set('SECONDARY NUCLEATION NMAX PARAMETER', 5.e5)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_sn5', 'telemac2d', 't2d_reservoir_multiclass_sn5.cas', cas=cas)
        ice_cas.set('SECONDARY NUCLEATION NMAX PARAMETER', 5.e6)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_sn6', 'telemac2d', 't2d_reservoir_multiclass_sn6.cas', cas=cas)
        ice_cas.set('SECONDARY NUCLEATION NMAX PARAMETER', 1.e7)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_sn7', 'telemac2d', 't2d_reservoir_multiclass_sn7.cas', cas=cas)
        del cas
        ...
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_nonuc', 'telemac2d', 't2d_reservoir_multiclass_nonuc.cas', cas=cas)
        del cas
        ...
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_buo1', 'telemac2d', 't2d_reservoir_multiclass_buo1.cas', cas=cas)
        ice_cas.set('MODEL FOR THE BUOYANCY VELOCITY', 2)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_buo2', 'telemac2d', 't2d_reservoir_multiclass_buo2.cas', cas=cas)
        ice_cas.set('MODEL FOR THE BUOYANCY VELOCITY', 3)
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_buo3', 'telemac2d', 't2d_reservoir_multiclass_buo3.cas', cas=cas)
        del cas
        ...
        ice_cas.write('ice_tmp.cas')
        cas.set('KHIONE STEERING FILE','ice_tmp.cas')
        self.add_study('vnv_nosal', 'telemac2d', 't2d_reservoir_multiclass_nosal.cas', cas=cas)
        del cas
    ...
    def _check_results(self):
        ...
        """
        self.check_epsilons('vnv_1:T2DRES', 'f2d_reservoir_multiclass.slf', eps=[1.E-6])
        self.check_epsilons('vnv_2:T2DRES', 'f2d_reservoir_multiclass.slf', eps=[1.E-6])
