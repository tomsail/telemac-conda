...
def get_studies():
    ...
    N = 2 * len(laws)  # Erosion + Erosion for each
...
def what_law_what_case(i, laws):
    ...
    law : str
        Law name
    TS_case : {"erosion", "erosion"}
    TS_name : {'Erosion in a flume', 'Erosion in a flume'}
