...
def get_studies():
    ...
    N = 2 * len(laws)  # Erosion + Deposition for each
...
def what_law_what_case(i, laws):
    ...
    law : str
        Law name
    TS_case : {"depot", "erosion"}
    TS_name : {'Deposition in a flume', 'Erosion in a flume'}

    """
    if i % 2 == 0:
        TS_case = "depot"
        TS_name = 'Deposition in a flume'
        i_law = i / 2
    else:
        TS_case = "erosion"
        TS_name = 'Erosion in a flume'
        i_law = i - 1 / 2
    law = laws[i_law]
