...
class VnvStudy(AbstractVnvStudy):
    ...
    def _init(self):
        ...
        self.sol()
        self.sol_file = "ANALYTIC_SOL_BUMPTRANS.txt"
    ...
    def _check_results(self):
        ...
        """
        self.check_epsilons('kin1_seq:T2DRES', 'f2d_bumptrans.slf', eps=[1.])
        self.check_epsilons('kin1_par:T2DRES', 'f2d_bumptrans.slf', eps=[1.])
        self.check_epsilons('kin1_seq:T2DRES', 'kin1_par:T2DRES', eps=[1.e-15])

        self.check_epsilons('kin2_seq:T2DRES', 'f2d_bumptrans.slf', eps=[10.])
        self.check_epsilons('kin2_par:T2DRES', 'f2d_bumptrans.slf', eps=[10.])
        self.check_epsilons('kin2_seq:T2DRES', 'kin2_par:T2DRES', eps=[6.e-4])

        self.check_epsilons('hllc_seq:T2DRES', 'f2d_bumptrans.slf', eps=[1e-8])
        self.check_epsilons('hllc_par:T2DRES', 'f2d_bumptrans.slf', eps=[1e-8])
    ...
    def _post(self):
        ...
        vnv_plot1d_polylines(\
            ...
            fig_name='img/bumptrans_free_surface_0',
            ylim=[0., 0.5],
            plot_bottom=True)
        ...
        vnv_plot1d_polylines(\
            ...
            ref_label='Analytical',
            fig_name='img/bumptrans_froude_number_0',
            y_label='Fr',
            plot_bottom=False)
        ...
        vnv_plot2d(\
            ...
            record=-1,
            fig_size=(10, 2),
            fig_name='img/bumptrans_elevation_2d',
        ...
        vnv_plot2d(\
            ...
            record=-1,
            fig_size=(10, 2),
            fig_name='img/bumptrans_velocity_2d_vector',
            cbar_label='Velocity (m/s)',
            x_label='x (m)', y_label='y (m)',
            filled_contours=True,
        ...
        vnv_plotbar_cpu_times(\
            self.action_time,
            fig_size=(7, 2.5),
            fig_name='img/bumptrans_cpu_times')
        ...
        vnv_plot1d_polylines(\
            ...
            ref_data=np.c_[self.sol.x, self.sol.E],
            ref_label='Analytical',
            fig_name='img/bumptrans_elevation_1dslice_comparison_tf',
            markers=True,
            markevery=15,
            plot_bottom=False)
        ...
        vnv_plot1d_polylines(\
            ...
            ref_label='Analytical',
            fig_size=(6, 5),
            fig_name='img/bumptrans_froud_1dslice_comparison_tf',
            markers=True,
            markevery=15,
            y_label='Fr',
            plot_bottom=False)
        ...
        vnv_plotbar(\
            ...
            y_scale='log',
            fig_name="img/bumptrans_errors_H_tf",
            annotate=True)
        ...
        vnv_plotbar(\
            ...
            y_scale='log',
            fig_name="img/bumptrans_errors_U_tf",
            annotate=True)
