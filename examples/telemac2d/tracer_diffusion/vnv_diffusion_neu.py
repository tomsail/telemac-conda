...
class VnvStudy(AbstractVnvStudy):
    ...
    def _check_results(self):
        ...
        """
        if self.mesh_type==1:
            self.check_epsilons('tpf_seq:T2DRES', 'f2d_diffusion_neu_tpf.slf', eps=[1e-6])
            self.check_epsilons('tpf_par:T2DRES', 'f2d_diffusion_neu_tpf.slf', eps=[1e-6])
            self.check_epsilons('tpf_seq:T2DRES', 'tpf_par:T2DRES', eps=[1e-6])

            self.check_epsilons('hefe_seq:T2DRES', 'f2d_diffusion_neu_hefe.slf', eps=[1e-6])
            self.check_epsilons('hefe_par:T2DRES', 'f2d_diffusion_neu_hefe.slf', eps=[1e-6])
            self.check_epsilons('hefe_seq:T2DRES', 'hefe_par:T2DRES', eps=[1e-6])

            self.check_epsilons('rtpf1_seq:T2DRES', 'f2d_diffusion_neu_rtpf1.slf', eps=[1e-6])
            self.check_epsilons('rtpf1_par:T2DRES', 'f2d_diffusion_neu_rtpf1.slf', eps=[1e-6])
            self.check_epsilons('rtpf1_seq:T2DRES', 'rtpf1_par:T2DRES', eps=[1e-6])

            self.check_epsilons('rtpf2_seq:T2DRES', 'f2d_diffusion_neu_rtpf2.slf', eps=[1e-6])
            self.check_epsilons('rtpf2_par:T2DRES', 'f2d_diffusion_neu_rtpf2.slf', eps=[1e-6])
            self.check_epsilons('rtpf2_seq:T2DRES', 'rtpf2_par:T2DRES', eps=[1e-6])

            self.check_epsilons('fe_seq:T2DRES', 'f2d_diffusion_neu_fe.slf', eps=[1e-6])
            self.check_epsilons('fe_par:T2DRES', 'f2d_diffusion_neu_fe.slf', eps=[1e-6])
    ...
    def _post(self):
        ...
        for j, res in  enumerate(res_list):
            for idx, record in enumerate(records):
                vnv_plot2d(\
                    ...
                    record=record,
                    fig_size=(10, 2),
                    fig_name='img/diffusion_neu_T1_{}_{}'.format(res_labels[j], record),
                ...
                vnv_plot2d(\
                    ...
                    record=record,
                    fig_size=(10, 2),
                    fig_name='img/diffusion_neu_T2_{}_{}'.format(res_labels[j], record),
                    filled_contours=True,
                    plot_mesh=True)
        ...
        vnv_plotbar_cpu_times(\
             self.action_time,
             fig_size=(7, 3),
             fig_name='img/t2d_diffusion_neu_cpu_times')
        ...
        vnv_plot1d_polylines(\
            ...
            y_label='z (m)',
            x_label='x (m)',
            fig_name='img/t2d_diffusion_neu_h_{}'.format(record),
            plot_bottom=True)
        ...
        for idx, record in enumerate(records):
            ...
            vnv_plot1d_polylines(\
                ...
                x_label='x (m)',
                ylim=[0,1],
                fig_name='img/t2d_diffusion_neu_T1_{}'.format(record),
                plot_bottom=True,
                markers=True,
                markevery=15)
            ...
            vnv_plot1d_polylines(\
                ...
                x_label='x (m)',
                ylim=[0,1],
                fig_name='img/t2d_diffusion_neu_T2_{}'.format(record),
                plot_bottom=True,
                markers=True,
                markevery=15)
