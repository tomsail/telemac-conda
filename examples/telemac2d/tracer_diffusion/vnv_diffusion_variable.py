...
class VnvStudy(AbstractVnvStudy):
    ...
    def _init(self):
        ...
        if self.mesh_type==1:
            ...
            self.cli_file = "geo_flume_sym_dir.cli"
        elif self.mesh_type==2:
            self.geo_file = "geo_flume.slf"
            self.cli_file = "geo_flume_dir.cli"
        elif self.mesh_type==3:
            self.geo_file = "geo_flume_unstruct.slf"
            self.cli_file = "geo_flume_unstruct_dir.cli"
    ...
    def _pre(self):
        ...
        cas.set('FORTRAN FILE' , 'user_fortran_variable')
    ...
    def _post(self):
        ...
        for j, res in  enumerate(res_list):
            for idx, record in enumerate(records):
                vnv_plot2d(\
                    ...
                    record=record,
                    fig_size=(10, 2),
                    fig_name='img/diffusion_var_T1_{}_{}'.format(res_labels[j], record),
                ...
                vnv_plot2d(\
                    ...
                    record=record,
                    fig_size=(10, 2),
                    fig_name='img/diffusion_var_T2_{}_{}'.format(res_labels[j], record),
                    filled_contours=True,
                    plot_mesh=True)
        ...
        vnv_plotbar_cpu_times(\
             self.action_time,
             fig_size=(7, 3),
             fig_name='img/t2d_diffusion_var_cpu_times')
        ...
        vnv_plot1d_polylines(\
            ...
            y_label='z (m)',
            x_label='x (m)',
            fig_name='img/t2d_diffusion_var_h_{}'.format(record),
            plot_bottom=True)
        ...
        for idx, record in enumerate(records):
            ...
            vnv_plot1d_polylines(\
                ...
                x_label='x (m)',
                ylim=[0,1],
                fig_name='img/t2d_diffusion_var_T1_{}'.format(record),
                plot_bottom=True,
                markers=True,
                markevery=15)
            ...
            vnv_plot1d_polylines(\
                ...
                x_label='x (m)',
                ylim=[0,1],
                fig_name='img/t2d_diffusion_var_T2_{}'.format(record),
                plot_bottom=True,
                markers=True,
                markevery=15)
