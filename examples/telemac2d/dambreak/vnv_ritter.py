...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        #======================================================================
        # charac run
        self.add_study('char_seq', 'telemac2d', 't2d_ritter-charac.cas')
        # charac run in parallel
        cas = TelemacCas('t2d_ritter-charac.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('char_par', 'telemac2d', 't2d_ritter-charac_par.cas', cas=cas)
        del cas

        #======================================================================
        # Nerd run
        self.add_study('nerd_seq', 'telemac2d', 't2d_ritter-nerd.cas')
        # Nerd run in parallel
        cas = TelemacCas('t2d_ritter-nerd.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('nerd_par', 'telemac2d', 't2d_ritter-nerd_par.cas', cas=cas)
        del cas

        #======================================================================
        # eria run
        self.add_study('eria_seq', 'telemac2d', 't2d_ritter-eria.cas')
        # eria run in parallel
        cas = TelemacCas('t2d_ritter-eria.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('eria_par', 'telemac2d', 't2d_ritter-eria_par.cas', cas=cas)
        del cas

        #======================================================================
        # kin1 run
        self.add_study('kin1_seq', 'telemac2d', 't2d_ritter-kin1.cas')
        # kin1 run in parallel
        cas = TelemacCas('t2d_ritter-kin1.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('kin1_par', 'telemac2d', 't2d_ritter-kin1_par.cas', cas=cas)
        del cas

        #======================================================================
        # kin2 run
        self.add_study('kin2_seq', 'telemac2d', 't2d_ritter-kin2.cas')
        # kin1 run in parallel
        cas = TelemacCas('t2d_ritter-kin2.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('kin2_par', 'telemac2d', 't2d_ritter-kin2_par.cas', cas=cas)
        del cas

        #======================================================================
        # hllc run
        self.add_study('hllc_seq', 'telemac2d', 't2d_ritter-hllc.cas')
        # hllc run in parallel
        cas = TelemacCas('t2d_ritter-hllc.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('hllc_par', 'telemac2d', 't2d_ritter-hllc_par.cas', cas=cas)
        del cas
    ...
    def _check_results(self):
        ...
        self.check_epsilons('char_seq:T2DRES', 'f2d_ritter-char.slf', eps=[1e-8])
        self.check_epsilons('char_par:T2DRES', 'f2d_ritter-char.slf', eps=[1e-8])
        self.check_epsilons('char_seq:T2DRES', 'char_par:T2DRES', eps=[1.e-11])

        self.check_epsilons('nerd_seq:T2DRES', 'f2d_ritter-nerd.slf', eps=[1e-8])
        self.check_epsilons('nerd_par:T2DRES', 'f2d_ritter-nerd.slf', eps=[1e-8])
        self.check_epsilons('nerd_seq:T2DRES', 'nerd_par:T2DRES', eps=[1.e-10])

        self.check_epsilons('eria_seq:T2DRES', 'f2d_ritter-eria.slf', eps=[1e-8])
        self.check_epsilons('eria_par:T2DRES', 'f2d_ritter-eria.slf', eps=[1e-8])
        self.check_epsilons('eria_seq:T2DRES', 'eria_par:T2DRES', eps=[1.e-15])

        self.check_epsilons('kin1_seq:T2DRES', 'f2d_ritter-kin1.slf', eps=[1e-8])
        self.check_epsilons('kin1_par:T2DRES', 'f2d_ritter-kin1.slf', eps=[1e-8])
        self.check_epsilons('kin1_seq:T2DRES', 'kin1_par:T2DRES', eps=[1e-8])

        self.check_epsilons('kin2_seq:T2DRES', 'f2d_ritter-kin2.slf', eps=[1.])
        self.check_epsilons('kin2_par:T2DRES', 'f2d_ritter-kin2.slf', eps=[1.])
        self.check_epsilons('kin2_seq:T2DRES', 'kin2_par:T2DRES', eps=[1.])

        self.check_epsilons('hllc_seq:T2DRES', 'f2d_ritter-hllc.slf', eps=[1e-8])
        self.check_epsilons('hllc_par:T2DRES', 'f2d_ritter-hllc.slf', eps=[1e-8])
        self.check_epsilons('hllc_seq:T2DRES', 'hllc_par:T2DRES', eps=[1e-8])
    ...
    def _post(self):
        ...
        for idx, record in enumerate(records):
            ...
            vnv_plot2d(\
                ...
                record=record,
                fig_size=(10, 3),
                fig_name="img/t2d_ritter_kin1_depth2d_firstobs{}".format(record),
            ...
            if idx > 0:
                vnv_plot2d(\
                    ...
                    record=record,
                    fig_size=(10, 3),
                    fig_name="img/t2d_ritter_kin1_vel2d_firstobs{}".format(record),
                    fig_title=time_label,
        ...
        vnv_plotbar_cpu_times(\
            self.action_time,
            fig_size=(7, 3),
            fig_name='img/t2d_ritter_cpu_times')
        ...
        for idx, res in enumerate(res_list):
            ...
            fig_name = "img/t2d_ritter_{}_depth_100".format(res_labels[idx].lower())
        ...
        vnv_plot1d(\
            ...
            x_label='t',
            y_label='$E_c$',
            fig_name='img/t2d_ritter_kinetic_energy')
        ...
        vnv_plot1d(\
            ...
            x_label='t',
            y_label='$E_p$',
            fig_name='img/t2d_ritter_potential_energy')
        ...
        vnv_plot1d(\
            ...
            x_label='t',
            y_label='$E_m$',
            fig_name='img/t2d_ritter_total_energy')
        ...
        vnv_plot1d(\
            ...
            x_label='t',
            y_label='$M-M_0$',
            fig_name='img/t2d_ritter_mass_balance')
        ...
        vnv_plot1d(\
            ...
            fig_name='img/t2d_ritter_error_Linf_H')
        ...
        vnv_plot1d(\
            ...
            fig_name='img/t2d_ritter_error_Linf_U')
        ...
        vnv_plot1d(\
            ...
            fig_name='img/t2d_ritter_error_Linf_V')
        ...
        vnv_plot1d(\
            ...
            fig_name='img/t2d_ritter_error_L1_H')
        ...
        vnv_plot1d(\
            ...
            fig_name='img/t2d_ritter_error_L1_U')
        ...
        vnv_plot1d(\
            ...
            fig_name='img/t2d_ritter_error_L1_V')
        ...
        vnv_plot1d(\
            ...
            fig_name='img/t2d_ritter_error_L2_H')
        ...
        vnv_plot1d(\
            ...
            fig_name='img/t2d_ritter_error_L2_U')
        ...
        vnv_plot1d(\
            ...
            fig_name='img/t2d_ritter_error_L2_V')
        ...
        vnv_plotbar(\
            ...
            y_scale='log',
            fig_name="img/t2d_ritter_errors_timeintegral_H",
            annotate=True)
        ...
        vnv_plotbar(\
            ...
            y_scale='log',
            fig_name="img/t2d_ritter_errors_timeintegral_U",
            annotate=True)
        ...
        vnv_plotbar(\
            ...
            y_scale='log',
            fig_name="img/t2d_ritter_errors_timeintegral_V",
            annotate=True)
        ...
        vnv_plotbar(\
            ...
            y_scale='log',
            fig_name="img/t2d_ritter_errors_H_tf",
            annotate=True)
        ...
        vnv_plotbar(\
            ...
            y_scale='log',
            fig_name="img/t2d_ritter_errors_U_tf",
            annotate=True)
        ...
        vnv_plotbar(\
            ...
            y_scale='log',
            fig_name="img/t2d_ritter_errors_V_tf",
            annotate=True)
