...
!-----------------------------------------------------------------------
!
      TEXTE(23)   = 'BINGHM VISCOSITYPA.S            '
      TEXTE(24)   = 'YIELD STRESS    PA              '
      TEXTE(25)   = 'FLUID DENSITY   KG/M3           '
      TEXTPR(23) = 'BINGHM VISCOSITYPA.S            '
      TEXTPR(24) = 'YIELD STRESS    PA              '
      TEXTPR(25) = 'FLUID DENSITY   KG/M3           '
!
!-----------------------------------------------------------------------
!
      RETURN
