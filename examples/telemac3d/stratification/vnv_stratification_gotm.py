...
"""
Validation script for stratification_gotm
"""
...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        self.add_study('vnv_1',
                       'telemac3d',
                       't3d_stratification_gotm.cas')


        # stratification parallel mode
        cas = TelemacCas('t3d_stratification_gotm.cas', get_dico('telemac3d'))
