...
!
      ...
      USE DECLARATIONS_TELEMAC3D, ONLY : T3D_FILES, T3DRFO
      USE BIEF_DEF, ONLY :IPID, NCSIZE
      IMPLICIT NONE
!
      CHARACTER(LEN=30) :: RFONAME_1,RFONAME_2,RFONAME
!+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
!
...
!
      ...
      IF(NCSIZE.GT.1) THEN
        WRITE(RFONAME_1,*) NCSIZE+100000-1
        RFONAME_1 =  TRIM(RFONAME_1)
        RFONAME_1 =  ADJUSTL(RFONAME_1)

        WRITE(RFONAME_2,*) IPID+100000
        RFONAME_2 =  TRIM(RFONAME_2)
        RFONAME_2 =  ADJUSTL(RFONAME_2)

        RFONAME = T3D_FILES(T3DRFO)%TELNAME//RFONAME_1(2:6)//
     &        "-"//RFONAME_2(2:6)
      ELSE
        RFONAME = T3D_FILES(T3DRFO)%TELNAME
      ENDIF
      OPEN(NRFO,FILE=RFONAME,POSITION="APPEND")
      WRITE(NRFO,*)
