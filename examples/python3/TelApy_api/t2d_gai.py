...
def main(recompile=True):
    ...
    cas_file = path.join(root, 'examples', 'gaia', 'hippodrome-t2d',
                         't2d_4NCOb.cas')
    cpl_cas_file = path.join(root, 'examples', 'gaia', 'hippodrome-t2d',
                             'gai_4NCOb.cas')
    ...
    study = Telemac2d(path.basename(cas_file), user_fortran='user_fortran1',
