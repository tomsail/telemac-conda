...
def main(recompile=True):
    ...
    cas_file = path.join(root, 'examples', 'gaia', 'hippodrome-t3d',
                         't3d_4NCObs.cas')
    cpl_cas_file = path.join(root, 'examples', 'gaia', 'hippodrome-t3d',
                             'gai_4NCObs.cas')
    ...
    study = Telemac3d('t3d_4NCObs.cas', user_fortran='user_fortran',
