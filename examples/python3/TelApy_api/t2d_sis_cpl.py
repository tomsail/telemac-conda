...
def main(recompile=True):
    ...
    cas_file = path.join(root, 'examples', 'sisyphe', 'conservation',
                         't2d_conservation_api.cas')
    cpl_cas_file = path.join(root, 'examples', 'sisyphe', 'conservation',
                             'sis_conservation.cas')
